...
public strictfp class RobotPlayer {
  ...
  public static void run(RobotController rc) throws GameActionException {
    ...
    while (true) {
      ...
      try {
        ...
        // Clock.yield() makes the robot wait until the next turn, then it will perform this loop
        // again
        Clock.yield();
  ...
  static void runMiner() throws GameActionException {
    ...
    if (rc.getSoupCarrying() == RobotType.MINER.soupLimit) {
      ...
      if (goTo(hqLoc)) System.out.println("moved towards HQ");
  ...
  static void runDesignSchool() throws GameActionException {
    for (Direction dir : directions)
      if (tryBuild(RobotType.LANDSCAPER, dir)) System.out.println("made a landscaper");
  }

  static void runFulfillmentCenter() throws GameActionException {
    for (Direction dir : directions) tryBuild(RobotType.DELIVERY_DRONE, dir);
  }
  ...
  static void runDeliveryDrone() throws GameActionException {
    ...
    if (!rc.isCurrentlyHoldingUnit()) {
      // See if there are any enemy robots within striking range (distance 1 from lumberjack's
      // radius)
      RobotInfo[] robots =
  ...
  static boolean tryMove() throws GameActionException {
    for (Direction dir : directions) if (tryMove(dir)) return true;
    return false;
